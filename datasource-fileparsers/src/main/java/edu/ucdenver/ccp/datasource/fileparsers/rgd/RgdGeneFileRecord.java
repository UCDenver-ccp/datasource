...
import edu.ucdenver.ccp.fileparsers.hgnc.HgncApprovedGeneName;
...
public class RgdGeneFileRecord extends SingleLineFileRecord {
	...
	@RecordField
	private final HgncApprovedGeneName hgncApprovedGeneName; // 39
	@RecordField
	...
	public RgdGeneFileRecord(RgdID geneId, String geneSymbol, String geneName, String geneDescription, String fishBand,
			...
			EnsemblGeneID ensemblGeneId, String ncbiGeneRefseqStatus, HgncApprovedGeneName hgncApprovedGeneName,
	...
	public static RgdGeneFileRecord parseGeneFileLine(Line line, String oldReferenceAssemblyNumber,
		...
		HgncApprovedGeneName hgncApprovedGeneName = null;
		HprdID hprdId = null;
		OmimID omimId = null;
		...
		if (recordType.equals(RgdGeneFileType.RAT)) {
			...
			/* Human-specific fields */
			hgncApprovedGeneName = isHyphenOrEmpty(toks[index++]) ? null : new HgncApprovedGeneName(toks[index - 1]);// 39
