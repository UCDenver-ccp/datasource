...
public class PharmGkbDiseaseFileParserTest extends RecordReaderTester {
	...
	public void testParser() throws IOException {
		...
		DataSourceElement<String> r1 = r.getName();
		assertEquals("Weight gain", r1.getDataElement());
		DataSourceElement<String> r2 = r.getAlternativeNames().iterator().next();
		assertTrue(r.getAlternativeNames().size() == 1 && r2.getDataElement().equals("Weight increased"));
		...
		DataSourceElement<String> r3 = r.getName();
		assertEquals("5-fluorouracil associated toxicity", r3.getDataElement());
