...
public enum RdfNamespace {
	...
	RDF(org.openrdf.model.vocabulary.RDF.NAMESPACE),
	RDFS(org.openrdf.model.vocabulary.RDFS.NAMESPACE),
	...
	private static Map<String, RdfNamespace> longNameToNamespaceMap;

	static {
		longNameToNamespaceMap = new HashMap<String, RdfNamespace>();
	...
	/**
	 * @param longName
	 * @return the {@link RdfNamespace} for the input long name, e.g. return
	 *         {@link RdfNamespace#MGI} for an input of "http://www.informatics.jax.org/"
	 * @throws IllegalArgumentException
	 *             if the input cannot be mapped to an {@link RdfNamespace}
	 */
	public static RdfNamespace getNamespace(String longName) {
	...
	public static RdfNamespace getNamespace(DataSource ds) {
		RdfNamespace ns = null;
		try {
			ns = RdfNamespace.valueOf(ds.name());
		} catch (Exception e) {
			ns = null;
		}
		if (ns == null) {
